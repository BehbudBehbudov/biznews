...
from biznews.core.forms import ContactForm, NewsletterForm, CommentForm
from django.contrib import messages
from django.core.paginator import Paginator
from biznews.news_backend.settings import EMAIL_HOST_USER, BASE_DIR
...
def home_view(request):
    BigSlider = slider_news.objects.all().order_by('-created_date')[:3](is_active=True)
